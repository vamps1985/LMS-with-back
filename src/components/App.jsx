...
// TODO: Is this registr function need to somebody??? If not, delete it:
...
render() {
  const { isLogin, registration, login } = this.state;

  return (
    <Fragment>
      <Header showModal={this.showModal} isLogin={ isLogin }/>
      <Switch>
        <PrivateRoute
          exact path="/"
          redirectTo="/board"
      ...
      {registration && <Registration closeModal={this.closeModal} />}
      {login && 
        <ModalWindow 
          modalId="login"
          title="Вход _ "
