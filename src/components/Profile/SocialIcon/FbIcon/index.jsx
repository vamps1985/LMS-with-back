...
const FbIcon = ({ socialUrl, IconWidth, IconHeight }) => (
  <a href={ socialUrl } className="SocialIcon" >
    <svg xmlns="http://www.w3.org/2000/svg" width={IconWidth} height={IconHeight} viewBox="0 0 612 612">
