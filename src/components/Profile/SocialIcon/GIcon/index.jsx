...
const GIcon = ({ GsocialUrl, GIconWidth, GIconHeight }) => (
  <a href={ GsocialUrl } className="SocialIcon" >
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 235 235" width={GIconWidth} height={GIconHeight}>
